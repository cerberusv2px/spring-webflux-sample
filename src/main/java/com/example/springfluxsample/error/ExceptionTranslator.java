package com.example.springfluxsample.error;
...
import com.example.springfluxsample.api.HeaderUtil;
import com.example.springfluxsample.api.errors.EmailAlreadyUsedException;
import com.example.springfluxsample.api.errors.InvalidPasswordException;
import com.example.springfluxsample.api.errors.LoginAlreadyUsedException;
import com.example.springfluxsample.domain.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    private String applicationName = "cloudhouse";
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(EmailAlreadyUsedException ex,
        ...
        return create(problem, request, HeaderUtil
            .createFailureAlert(applicationName, false, problem.getEntityName(),
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils
            .containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.",
                "com.evolveasia.cloudview.cloudhub");
    }
}
